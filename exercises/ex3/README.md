...
1. Find your Group in the Content Manager, open it and choose **Edit**. In the app list, search for your newly created Native App tile `SAP SuccessFactors ##` and click switch button in the "Assignment Status" column.
