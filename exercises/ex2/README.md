...
1. Navigate to the **Content Manager** tab on Site Manager, then click the **Create** button and select **App** from the dropdown list.
...
> **NOTE:** For the SAP TechEd 2023 Hands-on Session, a role has already been created and assigned to you. You just need to assign your freshly created App to your role. When executing this tutorial outside of SAP TechEd, it might be required to create a new Role or reuse an existing one.
...
3. Once done, you can find your created URL-Tile in the **Apps** pane - you can filter for your ## via the searchbar on the right. Once you found your tile in the list press the **Switch-Button** in the **Assignments Status Column** to assign it to your role.
...
> **NOTE:** For the SAP TechEd 2023 Hands-on Session, the role has already been assigned to you. When executing this tutorial outside of SAP TechEd, you need to assign the role to the applicable users in the SAP BTP Cockpit (like in the previous exercise).
...
1. To create a new Group, navigate back to the Content Manager, click the **Create** button and select **Group**.
...
3. Then search for and assign your App on the right side with the Slider-Button in the Assignment Status column.
...
<p align="center">
<img src="./images/tut2-18.png" width="40%" />
</p>
